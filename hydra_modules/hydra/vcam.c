...
#else
// TODO(imagyar): Fake cvcorename kernel support for now
...
static uint64_t g_shname_tab[VCAM_NAME_COUNT] = {
    CVCORE_NAME_DECL(HSI_VCAM_INBUF0),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF1),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF2),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF3),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF4),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF5),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF6),
    CVCORE_NAME_DECL(HSI_VCAM_INBUF7),
};
#endif
