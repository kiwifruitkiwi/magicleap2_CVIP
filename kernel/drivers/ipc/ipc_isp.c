...
#ifdef CONFIG_IPC_VCAM_ISP
void cam_ctrl_response(struct isp_ipc_device *dev, int cam_id,
...
#ifdef CONFIG_IPC_VCAM_ISP
void out_buff_release(struct isp_ipc_device *dev, enum isp_camera cam_id,
...
#ifdef CONFIG_IPC_VCAM_ISP
	ipc_vcam_isp_ctrl_notification(isp_dev,
				       CAM0_CONTROL + cam_id,
				       &msg->data);
...
#ifdef CONFIG_IPC_VCAM_ISP
	ipc_vcam_isp_outputio_notification(isp_dev,
					   CAM0_OUTPUT_YUV_0 +
...
#ifdef CONFIG_IPC_VCAM_ISP
	ipc_vcam_isp_stats_notification(isp_dev,
					CAM0_IR_STAT +
...
#ifdef CONFIG_IPC_VCAM_ISP
		ipc_vcam_isp_inputio_notification(isp_dev,
...
#ifdef CONFIG_IPC_VCAM_ISP
		ipc_vcam_isp_dma_status_notification(isp_dev,
...
#ifdef CONFIG_IPC_VCAM_ISP
	if (ipc_vcam_isp_init(dev)) {
		pr_err("Cannot initialize Sensor Core Interface\n");
		return -1;
	}
#endif
...
#ifdef CONFIG_IPC_VCAM_ISP
	ipc_vcam_isp_store_input_base(res_in.start);
#endif
