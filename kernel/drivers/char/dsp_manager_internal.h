...
#define DSP_INFO(fmt, ...) \
	pr_info("dsp_manager: %s: " fmt, __func__, ##__VA_ARGS__)
...
struct dsp_device_t {
	...
	void __iomem *postcode_register[8];
	void __iomem *perf_register[8];
	void __iomem *tcm[8];
...
struct dsp_state_t {
	...
	void __iomem *postcode_register;
	void __iomem *perf_register;
	int dsp_mode;
	int submit_mode;
