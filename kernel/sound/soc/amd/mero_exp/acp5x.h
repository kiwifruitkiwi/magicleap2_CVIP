...
#include "acp5x-fw-driver-common.h"
...
#define FIRMWARE_ACP5x "fwimage_5_0.sbin"
#define FIRMWARE_ACP5x_UNSIGNED "fwimage_5_0.bin"
#define FIRMWARE_ACP5x_DATA_BIN "fwdata_5_0.bin"
#define ACP_ERROR_MASK                                0x20000000
#define ACP_DMA_MASK                                  0xFF
#define ACP_WOV_MASK				      0x80000000
#define ACP_SHA_STAT                                  0x8000
#define ACP_EXT_INTR_ERROR_STAT                       0x20000000
#define ACP_DMA_STAT				      0xFF
#define ACP_WOV_STAT				      0x80000000
...
#define ACP_DEFAULT_DRAM_LENGTH                       0x00100000
...
#define ACP_DRAM_PAGE_COUNT 256
#define ACP_DMA_CH_RUN 0x02
#define ACP_DMA_CH_IOC_ENABLE 0x04
#define ACP_DEVICE_ID 0x15e2

#define ACP_MAXIMUM_ACLK     0x3B9ACA00      /* 1000MHz */
...
#define ACP_600MHZ_ACLK      0x23C34600      /* 600Mhz */
#define ACP_800MHZ_ACLK      0x2FAF0800      /* 800Mhz */
#define ACP_1000MHZ_ACLK     0x3B9ACA00      /* 1000Mhz */
 ...
 * disable_runtime_pm - this flag will disable runtime pm during probe
...
struct acp5x_dev_data {
	...
	unsigned int i2s_mclk_freq;
	unsigned int dma_ioc_event;
	unsigned int disable_runtime_pm;
...
int send_ev_command(struct acp5x_dev_data *adata, unsigned int val);
...
int ev_acp_i2s_dma_stop(struct acp5x_dev_data *acp5x_data,
			unsigned int instance);
int ev_set_acp_clk_frequency(u32 clock_type,
			     u64 clock_freq,
			     struct acp5x_dev_data *acp5x_data);
int ev_acp_memory_pg_shutdown_enable(struct acp5x_dev_data *acp5x_data,
				     unsigned int mem_bank);
int ev_acp_memory_pg_shutdown_disable(struct acp5x_dev_data *acp5x_data,
				      unsigned int mem_bank);
int ev_acp_memory_pg_deepsleep_on(struct acp5x_dev_data *acp5x_data,
				  unsigned int mem_bank);
int ev_acp_memory_pg_deepsleep_off(struct acp5x_dev_data *acp5x_data,
				   unsigned int mem_bank);
int ev_set_i2s_mclk_frequency(u64 clock_freq,
			      struct acp5x_dev_data *adata);
bool acp_remove_responses(struct acp5x_dev_data *adata, bool remove_all,
